...
@Component({
    ...
    <mat-sidenav-container class="sidenav-container">
      <mat-sidenav mode="side" opened class="sidenav admin-sidenav">
        ...
        <mat-nav-list class="nav-list">
          <a mat-list-item routerLink="/admin/dashboard" routerLinkActive="active-link" (click)="go('/admin/dashboard', $event)">
            <mat-icon matListItemIcon>dashboard</mat-icon>
            <span matListItemTitle>Dashboard</span>
          </a>
          <a mat-list-item routerLink="/admin/employees" routerLinkActive="active-link" (click)="go('/admin/employees', $event)">
            <mat-icon matListItemIcon>people</mat-icon>
            <span matListItemTitle>Employees</span>
          </a>
          <a mat-list-item routerLink="/admin/departments" routerLinkActive="active-link" (click)="go('/admin/departments', $event)">
            <mat-icon matListItemIcon>business</mat-icon>
            <span matListItemTitle>Departments</span>
          </a>
          <a mat-list-item routerLink="/admin/designations" routerLinkActive="active-link" (click)="go('/admin/designations', $event)">
            <mat-icon matListItemIcon>badge</mat-icon>
            <span matListItemTitle>Designations</span>
          </a>
          <a mat-list-item routerLink="/admin/leaves" routerLinkActive="active-link" (click)="go('/admin/leaves', $event)">
            <mat-icon matListItemIcon>event_busy</mat-icon>
            <span matListItemTitle>Leave Management</span>
          </a>
          <a mat-list-item routerLink="/admin/holidays" routerLinkActive="active-link" (click)="go('/admin/holidays', $event)">
            <mat-icon matListItemIcon>celebration</mat-icon>
            <span matListItemTitle>Holidays</span>
          </a>
          <a mat-list-item routerLink="/admin/announcements" routerLinkActive="active-link" (click)="go('/admin/announcements', $event)">
            <mat-icon matListItemIcon>campaign</mat-icon>
            <span matListItemTitle>Announcements</span>
          </a>
          <a mat-list-item routerLink="/admin/view-profile" routerLinkActive="active-link" (click)="go('/admin/view-profile', $event)">
            <mat-icon matListItemIcon>manage_search</mat-icon>
            <span matListItemTitle>Search Profile</span>
          </a>
          <a mat-list-item routerLink="/admin/left-employees" routerLinkActive="active-link" (click)="go('/admin/left-employees', $event)">
            <mat-icon matListItemIcon>person_off</mat-icon>
            <span matListItemTitle>Left Employees</span>
          </a>
          <a mat-list-item routerLink="/admin/goals" routerLinkActive="active-link" (click)="go('/admin/goals', $event)">
  ...
  styles: [`
    ...
    ::ng-deep .admin-sidenav .nav-list .active-link .mdc-list-item__primary-text { color: #fff !important; }
    ::ng-deep .admin-sidenav .nav-list .active-link { background: rgba(255,255,255,0.20) !important; }
    ::ng-deep .admin-sidenav .nav-list .active-link .mat-icon { color: #90caf9 !important; }
  `]
})
