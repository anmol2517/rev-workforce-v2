    ...
    <div class="page-container">
      ...
      <div *ngFor="let g of filteredGoals" class="card" style="margin-bottom:14px;padding:20px">
          ...
          <div style="flex:1;min-width:200px">
            ...
            <div *ngIf="g.progressPercentage !== undefined && g.progressPercentage !== null">
              <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                ...
                <span style="font-size:11px;font-weight:600;color:#1a237e">{{ g.progressPercentage }}%</span>
              </div>
              <div style="height:6px;background:#e0e0e0;border-radius:3px;overflow:hidden">
                <div [style.width]="g.progressPercentage + '%'"
                  [style.background]="g.progressPercentage >= 100 ? '#2e7d32' : '#1a237e'"
        ...
        <div *ngIf="g.managerComment"
          ...
          <span style="font-size:13px;color:#555">{{ g.managerComment }}</span>
        </div>
      </div>
    </div>
  `
...
export class AdminGoalsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.adminService.getAllGoals().subscribe({
      next: (d: any) => {
        this.allGoals = Array.isArray(d) ? d : (d?.data || d?.content || []);
