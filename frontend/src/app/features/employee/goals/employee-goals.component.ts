      ...
      <mat-tab-group>
        ...
        <mat-tab label="Goals List">
          <div style="margin-top:16px">
            ...
            <!-- Active Goals -->
            <div *ngFor="let g of activeGoals" class="card" style="margin-bottom:14px;padding:20px">
                ...
                <div style="flex:1;min-width:200px">
                  ...
                  <div style="margin-bottom:12px">
                    <div style="display:flex;justify-content:space-between;font-size:12px;color:#555;margin-bottom:4px">
                      <span>Progress</span>
                      <span style="font-weight:600">{{ g.progressPercentage || 0 }}%</span>
                    </div>
                    <mat-progress-bar mode="determinate"
                      [value]="g.progressPercentage || 0"
                      [color]="(g.progressPercentage || 0) >= 100 ? 'primary' : 'accent'">
                    </mat-progress-bar>
                  </div>

                  <div *ngIf="g.managerComment"
                    ...
                    <div style="font-size:13px;color:#555">{{ g.managerComment }}</div>
                  </div>
                </div>
                  ...
                  <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:8px">
                    <div style="flex:1">
                      ...
                      <div style="font-size:11px;color:#aaa;margin-bottom:8px">
                        Deadline: {{ g.deadline | date:'dd MMM yyyy' }}
                        <span *ngIf="g.progressPercentage !== null && g.progressPercentage !== undefined">
                          &nbsp;·&nbsp; Progress: {{ g.progressPercentage }}%
                        </span>
                      </div>
                      <div *ngIf="g.managerComment"
                        style="padding:8px;background:#f9f9f9;border-radius:6px;font-size:12px;color:#888">
                        <span style="font-weight:600">Manager: </span>{{ g.managerComment }}
                      </div>
                    </div>
          ...
          <div class="card" style="margin-top:16px;max-width:580px">
            ...
            <form [formGroup]="goalForm" (ngSubmit)="createGoal()">
              <mat-form-field appearance="outline" style="width:100%">
                ...
                <textarea matInput formControlName="goalDescription" rows="3"
...
export class EmployeeGoalsComponent implements OnInit {
  ...
  loadGoals(): void {
    ...
    this.employeeService.getGoals().subscribe({
      next: (d: any) => {
        ...
        this.activeGoals = this.allGoals.filter(g =>
  ...
  openProgress(g: Goal): void {
    ...
    this.progressValue = g.progressPercentage || 0;
  ...
  submitProgress(): void {
    ...
    this.employeeService.updateGoalProgress(this.selectedGoalId, this.progressValue, this.progressStatus).subscribe({
      next: () => {
