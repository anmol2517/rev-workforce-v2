...
@Component({
    ...
    <mat-sidenav-container class="sidenav-container">
      <mat-sidenav mode="side" opened class="sidenav employee-sidenav">
        ...
        <mat-nav-list class="nav-list">
          <a mat-list-item routerLink="/employee/dashboard" routerLinkActive="active-link" (click)="go('/employee/dashboard', $event)">
            <mat-icon matListItemIcon>dashboard</mat-icon>
            <span matListItemTitle>Dashboard</span>
          </a>
          <a mat-list-item routerLink="/employee/profile" routerLinkActive="active-link" (click)="go('/employee/profile', $event)">
            <mat-icon matListItemIcon>person</mat-icon>
            <span matListItemTitle>My Profile</span>
          </a>
          <a mat-list-item routerLink="/employee/leaves" routerLinkActive="active-link" (click)="go('/employee/leaves', $event)">
            <mat-icon matListItemIcon>event_busy</mat-icon>
            <span matListItemTitle>My Leaves</span>
          </a>
          <a mat-list-item routerLink="/employee/performance-reviews" routerLinkActive="active-link" (click)="go('/employee/performance-reviews', $event)">
            <mat-icon matListItemIcon>star_rate</mat-icon>
            <span matListItemTitle>Performance</span>
          </a>
          <a mat-list-item routerLink="/employee/goals" routerLinkActive="active-link" (click)="go('/employee/goals', $event)">
            <mat-icon matListItemIcon>flag</mat-icon>
            <span matListItemTitle>My Goals</span>
          </a>
          <a mat-list-item routerLink="/employee/announcements" routerLinkActive="active-link" (click)="go('/employee/announcements', $event)">
            <mat-icon matListItemIcon>campaign</mat-icon>
            <span matListItemTitle>Announcements</span>
          </a>
          <a mat-list-item routerLink="/employee/directory" routerLinkActive="active-link" (click)="go('/employee/directory', $event)">
            <mat-icon matListItemIcon>contacts</mat-icon>
            <span matListItemTitle>Directory</span>
          </a>
          <a mat-list-item routerLink="/employee/notifications" routerLinkActive="active-link" (click)="go('/employee/notifications', $event)">
  ...
  styles: [`
    ...
    ::ng-deep .employee-sidenav .nav-list a.active-link { background: rgba(255,255,255,0.18) !important; }
    ::ng-deep .employee-sidenav .nav-list mat-icon { color: rgba(255,255,255,0.8) !important; }
    ::ng-deep .employee-sidenav .nav-list a.active-link mat-icon { color: #ce93d8 !important; }
    ::ng-deep .employee-sidenav .nav-list a.active-link .mdc-list-item__primary-text { color: #fff !important; font-weight:600 !important; }
  `]
})
