    ...
    <div class="page-container">
      ...
      <div *ngIf="profile && !loading" style="display:grid;grid-template-columns:300px 1fr;gap:24px">
        ...
        <div class="card" style="padding:24px;text-align:center">
          ...
          <span [style.background]="profile.active==='Working'?'#e8f5e9':'#fce4ec'"
            [style.color]="profile.active==='Working'?'#2e7d32':'#c62828'"
          ...
          <div style="margin-top:16px;text-align:left;border-top:1px solid #f0f0f0;padding-top:14px">
            ...
            <p *ngIf="profile.phoneNumber" style="display:flex;align-items:center;gap:8px;color:#555;font-size:13px;margin:8px 0">
              <mat-icon style="font-size:16px;width:16px;height:16px;color:#7b1fa2">phone</mat-icon>{{ profile.phoneNumber }}
            </p>
          ...
          <div class="card" style="padding:24px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
              ...
              <div style="padding:14px;background:#e8eaf6;border-radius:10px">
                ...
                <div style="font-weight:700;color:#1a237e">{{ profile.active }}</div>
              </div>
          ...
          <div *ngIf="editMode" class="card" style="padding:24px;border-left:4px solid #4a148c">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
              ...
              <mat-form-field appearance="outline">
                ...
                <input matInput [(ngModel)]="editData.phoneNumber" placeholder="+91 XXXXX XXXXX" />
              </mat-form-field>
              <mat-form-field appearance="outline">
...
export class EmployeeProfileComponent implements OnInit {
  ...
  downloadPdf(): void {
    ...
    <div class="grid">
      ...
      <div class="box"><div class="label">Phone</div><div class="value">${e.phoneNumber||'N/A'}</div></div>
      ...
      <div class="box"><div class="label">Status</div><div class="value">${e.active}</div></div>
