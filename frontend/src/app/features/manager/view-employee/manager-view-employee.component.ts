    ...
    <div class="page-container">
      ...
      <div *ngIf="employee && !loading" style="display:grid;grid-template-columns:300px 1fr;gap:24px">
        ...
        <div class="card" style="padding:24px;text-align:center">
          ...
          <span class="status-chip APPROVED" style="display:inline-block">{{ employee.active }}</span>
          ...
          <div style="margin-top:16px;text-align:left;border-top:1px solid #f0f0f0;padding-top:14px">
            ...
            <p *ngIf="employee.phoneNumber" style="display:flex;align-items:center;gap:8px;color:#555;font-size:13px;margin:8px 0">
              <mat-icon style="font-size:16px;width:16px;height:16px">phone</mat-icon>{{ employee.phoneNumber }}
            </p>
          ...
          <div class="card" style="padding:24px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
              ...
              <div style="padding:14px;background:#e8eaf6;border-radius:10px">
                ...
                <div style="font-weight:700;color:#1a237e">{{ employee.active }}</div>
              </div>
  ...
  ngOnInit(): void {
    ...
    this.managerService.getTeamMembers().subscribe({
      next: (team: any) => {
        ...
        const found = list.find(e => e.id === this.employeeId);
        if (found) {
          this.employee = found;
  ...
  downloadPdf(): void {
    ...
    const html = `<html><head><title>Employee Report</title>
      <style>
        ...
        <span class="badge">${e.active}</span><span class="badge">${e.role}</span>
        <div class="grid">
